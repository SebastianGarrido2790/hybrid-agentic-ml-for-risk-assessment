"""
Script to analyze class distribution in the raw dataset.

This utility loads the raw financial and PD data, merges them,
and prints the total count and ratio of positive samples (defaults).
"""
